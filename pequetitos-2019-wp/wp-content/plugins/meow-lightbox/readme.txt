...
Lightbox built for photographers, by photographers, with EXIF information and more.

== Description ==

Lightbox built for photographers, by photographers :) If you want to see how it performs, have a look at one of my post on my website, for example this one: [Best Abandoned Places in Japan](https://offbeatjapan.org/best-abandoned-places-2014/). Or with a gallery, in that case, any page on [Haikyo.org](https://haikyo.org). And here is the official page: [Meow Lightbox](https://meowapps.com/meow-lightbox/).
...
**GALLERY.** We believe that choice of the gallery system depends on you. We however recommend you to use the [Meow Gallery](https://wordpress.org/plugins/meow-gallery/).
